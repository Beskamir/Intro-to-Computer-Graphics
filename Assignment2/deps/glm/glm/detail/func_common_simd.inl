...
namespace detail
{
	...
	struct compute_abs_vector<float, P, tvec4, true>
	{
		GLM_FUNC_QUALIFIER static tvec4<float, P> call(tvec4<float, P> const & v)
		{
			...
			result.shaderData = glm_vec4_abs(v.shaderData);
			return result;
		}
	};
	...
	struct compute_abs_vector<int, P, tvec4, true>
	{
		GLM_FUNC_QUALIFIER static tvec4<int, P> call(tvec4<int, P> const & v)
		{
			...
			result.shaderData = glm_ivec4_abs(v.shaderData);
			return result;
		}
	};
	...
	struct compute_floor<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = glm_vec4_floor(v.shaderData);
			return result;
		}
	};
	...
	struct compute_ceil<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = glm_vec4_ceil(v.shaderData);
			return result;
		}
	};
	...
	struct compute_fract<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = glm_vec4_fract(v.shaderData);
			return result;
		}
	};
	...
	struct compute_round<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = glm_vec4_round(v.shaderData);
			return result;
		}
	};
	...
	struct compute_mod<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = glm_vec4_mod(x.shaderData, y.shaderData);
			return result;
		}
	};
	...
	struct compute_min_vector<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = _mm_min_ps(v1.shaderData, v2.shaderData);
			return result;
		}
	};
	...
	struct compute_min_vector<int32, P, tvec4, true>
	{
		GLM_FUNC_QUALIFIER static tvec4<int32, P> call(tvec4<int32, P> const & v1, tvec4<int32, P> const & v2)
		{
			...
			result.shaderData = _mm_min_epi32(v1.shaderData, v2.shaderData);
			return result;
		}
	};
	...
	struct compute_min_vector<uint32, P, tvec4, true>
	{
		GLM_FUNC_QUALIFIER static tvec4<int32, P> call(tvec4<uint32, P> const & v1, tvec4<uint32, P> const & v2)
		{
			...
			result.shaderData = _mm_min_epu32(v1.shaderData, v2.shaderData);
			return result;
		}
	};
	...
	struct compute_max_vector<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = _mm_max_ps(v1.shaderData, v2.shaderData);
			return result;
		}
	};
	...
	struct compute_max_vector<int32, P, tvec4, true>
	{
		...
		{
			tvec4<int32, P> result(uninitialize);
			result.shaderData = _mm_max_epi32(v1.shaderData, v2.shaderData);
			return result;
		}
	};
	...
	struct compute_max_vector<uint32, P, tvec4, true>
	{
		...
		{
			tvec4<uint32, P> result(uninitialize);
			result.shaderData = _mm_max_epu32(v1.shaderData, v2.shaderData);
			return result;
		}
	};
	...
	struct compute_clamp_vector<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = _mm_min_ps(_mm_max_ps(x.shaderData, minVal.shaderData), maxVal.shaderData);
			return result;
		}
	};
	...
	struct compute_clamp_vector<int32, P, tvec4, true>
	{
		...
		{
			tvec4<int32, P> result(uninitialize);
			result.shaderData = _mm_min_epi32(_mm_max_epi32(x.shaderData, minVal.shaderData), maxVal.shaderData);
			return result;
		}
	};
	...
	struct compute_clamp_vector<uint32, P, tvec4, true>
	{
		...
		{
			tvec4<uint32, P> result(uninitialize);
			result.shaderData = _mm_min_epu32(_mm_max_epu32(x.shaderData, minVal.shaderData), maxVal.shaderData);
			return result;
		}
	};
...
#			if 0 && GLM_ARCH & GLM_ARCH_AVX
				Result.shaderData = _mm_blendv_ps(x.shaderData, y.shaderData, Mask);
#			else
				Result.shaderData = _mm_or_ps(_mm_and_ps(Mask, y.shaderData), _mm_andnot_ps(Mask, x.shaderData));
#			endif
			return Result;
		}
	};
/* FIXME
	...
	struct compute_step_vector<float, P, tvec4>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = glm_vec4_step(edge.shaderData, x.shaderData);
			return result;
		}
	};
*/
	...
	struct compute_smoothstep_vector<float, P, tvec4, true>
	{
		...
		{
			tvec4<float, P> result(uninitialize);
			result.shaderData = glm_vec4_smoothstep(edge0.shaderData, edge1.shaderData, x.shaderData);
			return result;
		}
	};
}//namespace detail
